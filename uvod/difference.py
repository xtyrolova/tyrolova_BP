...
imageA = cv2.imread(args["first"], cv2.IMREAD_GRAYSCALE)
imageB = cv2.imread(args["second"], cv2.IMREAD_GRAYSCALE)
...
imageA = cv2.resize(imageA, (900,900))
imageB = cv2.resize(imageB, (900,900))
