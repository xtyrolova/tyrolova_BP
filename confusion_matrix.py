...
# print(actual_mse)
# print(prediction_mse)
x_train, x_test, y_train, y_test = train_test_split(prediction_mse, actual_mse, test_size=0.2, random_state=1)
...
x_train, x_test, y_train, y_test = train_test_split(prediction_ssim, actual_ssim, test_size=0.2, random_state=1)
...
cm2 = confusion_matrix(x_test, y_test, labels=['1', '0'])
print(cm2)
# for i in range(len(ids)):
